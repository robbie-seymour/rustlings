...
```ps1
Start-BitsTransfer -Source https://raw.githubusercontent.com/rust-lang/rustlings/main/install.ps1 -Destination $pwd/install_rustlings.ps1; Unblock-File $pwd/install_rustlings.ps1; Invoke-Expression $pwd/install_rustlings.ps1
```
